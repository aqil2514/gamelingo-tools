...
export default function NotFound() {
  ...
  return (
    <div className={DIV_MAIN_STYLE + " py-20"}>
      ...
      <button onClick={() => router.back} className="block mx-auto text-center font-mclaren text-slate-200 bg-yellow-600 px-4 py-2">Kembali ke halaman sebelumnya</button>
    </div>
  );
}
