...
export default function HeroSection() {
  return (
    <div className="mt-14 w-full h-[50vh] bg-no-repeat bg-cover bg-fixed bg-bottom sm:bg-top bg-evertale-hero-pattern flex flex-col content-center justify-center">
      <h1 className="text-center text-white font-bold text-2xl md:text-5xl font-merienda mb-2">Evertale</h1>
      <p className="text-center text-white font-bold text-xs md:text-lg font-mclaren mb-2">Explore sprawling landscapes, bustling cities, and mythical dungeons in this expansive open-world RPG!</p>
