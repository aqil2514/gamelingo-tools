...
export default function App() {
  return (
    <div className="min-h-screen w-full grid grid-rows-[10fr_2fr]">
      <div style={{ background: "linear-gradient(to bottom, rgba(0,0,0,0.5), rgba(0,0,0,0.8)), url('/background/hero-wallpaper.webp')" }} className="mt-14 flex flex-col justify-center flex-wrap content-center">
