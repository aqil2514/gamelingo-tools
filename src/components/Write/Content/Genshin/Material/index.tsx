...
export default function Material() {
  ...
  const [material, setMaterial] =
    React.useState<GenshinImpact.ApiResponseMaterial>(
      {} as GenshinImpact.ApiResponseMaterial,
    );
  ...
  return (
    <>
      ...
      >
        <FetchApi
          elementId="material-name"
          msgNoInput="Material belum dipilih"
          msgNoData="Data material tidak ada"
          refElement="material-name"
          query="materials"
          setData={setMaterial}
        />
        <Input
        ...
        {dataExisting ? (
          <>
            <Input
              ...
              onChange={(e) =>
                setMaterial({ ...material, typeText: e.target.value })
              }
              variant={VariantClass.dashboard}
            ...
            <Input
              ...
              onChange={(e) =>
                setMaterial({ ...material, rarity: Number(e.target.value) })
              }
              variant={VariantClass.dashboard}
            />
            <div>
            ...
            <Input
              ...
              onChange={(e) =>
                setMaterial({ ...material, sources: e.target.value })
              }
              variant={VariantClass.dashboard}
            />
            ...
            <ImageInput
              changeHandler={(e) =>
                changeHandler(e, setFileName, setPreviewLink)
              }
              fileName={fileName}
