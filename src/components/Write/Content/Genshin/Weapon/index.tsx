...
import ImageInput, {
  changeHandler as imageHandler,
} from "@/components/general/ImageInput";
...
type RefinementType = Pick<
  GenshinImpact.ApiResponseWeapon,
  "r1" | "r2" | "r3" | "r4" | "r5"
>;
...
export default function WeaponForm() {
  ...
  const [weapon, setWeapon] = React.useState<GenshinImpact.ApiResponseWeapon>(
    {} as GenshinImpact.ApiResponseWeapon,
  );
  const refinementData = ["r1", "r2", "r3", "r4", "r5"];

  function changeHandler(e: React.ChangeEvent<HTMLTextAreaElement>) {
    const textareas = document.querySelectorAll(
      "textarea[data-textarea='weapon-ref'",
  ...
  return (
    <>
      ...
      >
        <FetchApi
          elementId="weapon-name"
          refElement="weapon-name"
          msgNoData="Weapon tidak ditemukan"
          query="weapons"
          msgNoInput="Masukkan Nama Weapon"
          setData={setWeapon}
        />
        <Input
          disabled={isLoading}
        ...
        {dataExist ? (
          <>
            <div className="grid grid-cols-2">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setWeapon({ ...weapon, mainStatText: e.target.value })
                  }
                  variant={VariantClass.dashboard}
                />
              </div>
            ...
            <Input
              ...
              onChange={(e) =>
                setWeapon({ ...weapon, weaponText: e.target.value })
              }
              variant={VariantClass.dashboard}
            />
            ...
            <Textarea
              ...
              label="Weapon Lore"
              value={weapon.story}
              onChange={(e) => setWeapon({ ...weapon, story: e.target.value })}
            ...
            <Input
              ...
              value={weapon.rarity}
              onChange={(e) =>
                setWeapon({ ...weapon, rarity: Number(e.target.value) })
              }
              variant={VariantClass.dashboard}
            />
            ...
            <div className="border border-white rounded-xl p-4 my-4">
              <div>
                <h3 className="text-center font-bold font-poppins text-white">
                  Passive Weapon
                </h3>
                <Input
                  disabled={isLoading}
                  ...
                  onChange={(e) =>
                    setWeapon({ ...weapon, effectName: e.target.value })
                  }
                  variant={VariantClass.dashboard}
                />
              </div>
                  ...
                  <React.Fragment key={`weapon-ref-${refinement}-element`}>
                    <Textarea
                      ...
                      value={
                        (
                          weapon[
                            refinement as keyof GenshinImpact.ApiResponseWeapon
                          ] as GenshinImpact.ApiResponseWeapon[`r1`]
                        ).description
                      }
                      onChange={(e) =>
                        setWeapon({
            ...
            <ImageInput
              changeHandler={(e) =>
                imageHandler(e, setFilename, setPreviewLink)
              }
              fileName={fileName}
