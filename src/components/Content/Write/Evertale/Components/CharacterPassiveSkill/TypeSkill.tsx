    ...
    <div className="my-4">
      ...
      {choiceMode && (
        <>
          ...
          <TextField forId="passive-skill-type-select" label="passiveSkillType Select" variant="outline-variant-1" list="passive-skill-type-select-list" onKeyDown={keyDownHandler} />
