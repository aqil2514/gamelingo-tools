  ...
  return (
    <div className="px-4">
      <div className="flex gap-4">
        <Button className={VariantClass.submit} onClick={() => router.push("/write?game=genshin-impact&category=Weapon")}>
          Tambah Data
        </Button>
      ...
      <table id="table-Weapon-data" className={Table_Style.style1}>
        <thead>
          <tr>
      ...
      {contextMenu.isActive && <ContextMenu field="genshin-impact" subfield="Weapon" passData={data} />}

      {editMenu && <EditMenu field="genshin-impact" subfield="Weapon" />}

      {detailMenu && <DetailMenu field="genshin-impact" subfield="Weapon" />}
    </div>
  );
}
