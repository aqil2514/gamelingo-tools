import { useMenuContextData } from "@/components/Admin/ContextMenu/ContextProvider";
  ...
  return (
    <>
      <div className="flex gap-2 flex-wrap content-end items-center">
        <input type="radio" name="lang" checked={lang === "English"} onChange={() => {
      ...
      <div className="flex gap-2 flex-wrap content-end items-center">
        <input type="radio" name="lang" checked={lang === "Indonesian"} onChange={() => {
        router.replace(`/admin/data?field=${field}&subfield=${subfield}&lang=Indonesian`)
          setLang("Indonesian")}} id="indonesia-lang" />
